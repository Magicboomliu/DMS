...
from pipeline.CARLA_pipeline.inference.med_view_generation import SimpleUNet_Pipeline_UpScale
...
def Inference(args):
    ...
    # Load the Pipeline
    pipeline = SimpleUNet_Pipeline_UpScale(unet=unet,
                                    vae=vae,
    ...
    for fname in tqdm(fname_list):
        ...
        rendered_med_image_path = os.path.join(args.output_folder_path,med_fname)

        basename = os.path.basename(fname)
        rendered_med_image_folder = rendered_med_image_path[:-len(basename)]
        os.makedirs(rendered_med_image_folder,exist_ok=True)
        ...
        skimage.io.imsave(rendered_med_image_path,rendered_med)
