...
from pipeline.SF_pipeline.inference.Simple_UNet_UpscaleX import SimpleUNet_Pipeline_UpScaleX
...
def main(args=None):
    ...
    for contents in tqdm(fname_list):
        ...
        rendered_center_image_path = rendered_center_image_path.replace("left","center")
