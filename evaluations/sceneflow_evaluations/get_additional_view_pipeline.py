...
from pipeline.SF_pipeline.inference.Simple_UNet import SimpleUNet_Pipeline
...
def parse_args():
    parser = argparse.ArgumentParser(description="SF Inference")
...
def main(args=None):
    ...
    for fname in tqdm(fname_list):
        ...
        rendered_left_image_path = os.path.join(args.output_folder_path,fname)
        
        rendered_left_left_image_path = rendered_left_image_path.replace("left","left_left")
        rendered_right_right_image_path = rendered_left_left_image_path.replace("left_left","right_right")
