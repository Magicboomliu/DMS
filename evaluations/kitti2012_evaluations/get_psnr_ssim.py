...
if __name__=="__main__":
    ...
    for fname in tqdm(contents):
        ...
        gt_left_images = os.path.join(datapath,left)
        gt_right_images = os.path.join(datapath,right)
        ...
        rendered_left_from_right = os.path.join(target_datapath,left)
        rendered_right_from_left = os.path.join(target_datapath,right)
        
        print(rendered_left_from_right)
