...
def main(args=None):
    ...
    if scale_factor==3.0:
        saved_folder_name = "colored_033"
    elif scale_factor==2.0:
        saved_folder_name = "colored_C"
    elif scale_factor==1.5:
        saved_folder_name = "colored_067"
    else:
    ...
    for fname in tqdm(fname_list):
        ...
        rendered_center_image_path = rendered_center_image_path.replace("colored_0",saved_folder_name)
        ...
        if not os.path.exists(rendered_center_image_path):
