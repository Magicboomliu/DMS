...
def main(args=None):
    ...
    for fname in tqdm(fname_list):
        ...
        rendered_left_left_image_path = rendered_left_image_path.replace("colored_0","colored_LL")
        rendered_right_right_image_path = rendered_left_left_image_path.replace("colored_LL","colored_RR")
