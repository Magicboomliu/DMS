...
def main(args=None):
    ...
    for fname in tqdm(fname_list):
        ...
        rendered_left_left_image_path = rendered_left_image_path.replace("image_2","image_1")
        rendered_right_right_image_path = rendered_left_left_image_path.replace("image_1","image_4")
