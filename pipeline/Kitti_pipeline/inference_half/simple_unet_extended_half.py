...
class Extension_DMB_Half(DiffusionPipeline):
    ...
    def __call__(self,
        ...
        rgb_norm = rgb_norm.unsqueeze(1)
        
        if resolution_scale==0:
            rgb_norm = F.interpolate(rgb_norm,scale_factor=1/2,mode='bilinear',align_corners=False)
        elif resolution_scale==1:
            rgb_norm = F.interpolate(rgb_norm,scale_factor=1/4,mode='bilinear',align_corners=False)
        
        rgb_norm = rgb_norm.squeeze(1)
