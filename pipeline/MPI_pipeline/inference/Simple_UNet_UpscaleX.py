...
class SimpleUNet_Pipeline_UpscaleX(DiffusionPipeline):
    ...
    def __call__(self,
        ...
        batched_image= rgb_norm  # here the image is still around 0-1
        
        # upscale to x
        if upscale_factor>1.0:
            batched_image = F.interpolate(batched_image,
        ...
        if match_input_res:
            if upscale_factor>1:
                depth_pred_left = cv2.resize(depth_pred_left,(1024,440))
