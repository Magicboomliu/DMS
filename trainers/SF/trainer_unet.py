...
from trainers.SF.dataset_configuration import prepare_dataset
from pipeline.SF_pipeline.inference_half.simple_unet_pipeline_half import SimpleUNet_Pipeline_Half
...
def log_validation_left2ll(vae,text_encoder,tokenizer,
                              unet,
                              args,
                              accelerator,
                              scheduler,
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_loader):
            with accelerator.accumulate(unet):
                ...
                right_image_data = batch['right'] # final right
