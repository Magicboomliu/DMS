...
import sys
sys.path.append("../..")
from dataloader.kitti_dataloader.kitti_loader import KITTIRaw_Dataset,KITTIStereo_Dataset
from dataloader.kitti_dataloader import transforms
import os
import logging
...
# Get Dataset Here
def prepare_dataset_kitti2012_2015(datapath,
                    trainlist,
                    vallist,
                    logger=None,
                    batch_size = 1,
    ...
    train_dataset = KITTIStereo_Dataset(datapath=datapath,trainlist=trainlist,vallist=vallist,transform=train_transform,
                                     mode='train',targetHW = (384,1248))

    test_dataset = KITTIStereo_Dataset(datapath=datapath,trainlist=trainlist,vallist=vallist,transform=val_transform,
                                     mode='test',targetHW = (384,1248))
