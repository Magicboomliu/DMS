...
from trainers.KITTI.dataset_configuration import prepare_dataset_kitti2012_2015
...
def log_validation_right2left(vae,text_encoder,tokenizer,unet,args,accelerator,weight_dtype,scheduler,epoch,
                                input_image_path = "../input_examples/kitti/right_images/example0.png"
                   ):
    ...
    with torch.no_grad():
        ...
        rendered_example_saved_path = os.path.join(args.output_dir,"sd20_unet")
...
def log_validation_left2right(vae,text_encoder,tokenizer,unet,args,accelerator,weight_dtype,scheduler,epoch,
                   input_image_path ="../input_examples/kitti/left_images/example0.png"
                   ):
...
def main():
    ...
    with accelerator.main_process_first():
        (train_loader,test_loader), num_batches_per_epoch = prepare_dataset_kitti2012_2015(
                                                            datathread=4,
