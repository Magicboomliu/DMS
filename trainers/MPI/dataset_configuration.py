...
import sys
sys.path.append("../..")
from dataloader.mpi_dataloader.MPI_loader import MPI_Dataset
from dataloader.mpi_dataloader import transforms
import os
import logging
...
def prepare_dataset(datapath,
                    ...
                    datathread = 4,
                    targetHW =(440,1024),
                    visible_list=['final_left','final_right']
                    ):
    ...
    train_dataset = MPI_Dataset(datapath=datapath,trainlist=trainlist,
