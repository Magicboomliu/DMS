...
output_dir='/home/zliu/ACMMM2024/DiffusionMultiBaseline/outputs/trained_models/simple_unet_sd20'
train_batch_size=1
num_train_epochs=10
...
trainlist='/home/zliu/ACMMM2024/DiffusionMultiBaseline/datafiles/KITTI/kitti_raw_train.txt'
vallist='/home/zliu/ACMMM2024/DiffusionMultiBaseline/datafiles/KITTI/kitti_raw_val.txt'
output_dir='/home/zliu/ACMMM2024/DiffusionMultiBaseline/outputs/simple_unet_sd15'
train_batch_size=1
num_train_epochs=15
gradient_accumulation_steps=16
learning_rate=1e-5
lr_warmup_steps=0
dataloader_num_workers=4
tracker_project_name='simple_unet_sd15'
