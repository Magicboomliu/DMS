EVAL_UNet_MPI_Sub01(){
cd ../..
cd /home/zliu/Desktop/MyLatest/DiffusionMultiBaseline/evaluations
...
CUDA_VISIBLE_DEVICES=1  python unet_evaluate_pipeline.py \
        --pretrained_model_name_or_path $pretrained_model_name_or_path \
        --pretrained_unet_path $pretrained_unet_path \
        --datapath $datapath \
        --input_fname_list  $input_fname_list \
...
CUDA_VISIBLE_DEVICES=2 python unet_evaluate_pipeline.py \
        --pretrained_model_name_or_path $pretrained_model_name_or_path \
        --pretrained_unet_path $pretrained_unet_path \
        --datapath $datapath \
        --input_fname_list  $input_fname_list \
...
CUDA_VISIBLE_DEVICES=3 python unet_evaluate_pipeline.py \
        --pretrained_model_name_or_path $pretrained_model_name_or_path \
        --pretrained_unet_path $pretrained_unet_path \
        --datapath $datapath \
        --input_fname_list  $input_fname_list \
