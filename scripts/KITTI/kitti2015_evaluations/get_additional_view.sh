...
output_folder_path="/data1/KITTI/Rendered_Results/KITTI2015_Additional_Views"


CUDA_VISIBLE_DEVICES=1 python unet_new_view_pipeline.py \
...
datapath="/data1/KITTI/KITTIStereo/kitti_2015/"
input_fname_list="/home/zliu/Desktop/BMCV2024/datafiles/filenames/kitti_diffusion/kitti_2015_diffusion_list.txt"
output_folder_path="/data1/KITTI/Rendered_Results/KITTI2015_Additional_Views_OLD"

CUDA_VISIBLE_DEVICES=2 python unet_new_view_pipeline.py \
        --pretrained_model_name_or_path $pretrained_model_name_or_path \
        --pretrained_unet_path $pretrained_unet_path \
        --datapath $datapath \
        --input_fname_list  $input_fname_list \
