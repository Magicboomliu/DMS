...
from dataloader.kitti_dataloader.calib_parse import parse_calib
...
class KITTIStereo_Dataset(Dataset):
    def __init__(self,
                 datapath,
                 trainlist,
                 vallist,
                 ...
                 targetHW = (384,1248),
                 save_filename=False):
        super(KITTIStereo_Dataset,self).__init__()
        ...
        for line in lines:
            splits = line.split()
            left_image_path = splits[0]
            right_image_path = splits[1]
            
            assert left_image_path !=right_image_path
