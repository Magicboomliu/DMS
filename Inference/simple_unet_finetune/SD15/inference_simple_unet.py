...
from pipeline.inference.SD15_UNet_Simple_Pipeline import SD15UNet_Simple_Finetune_Pipeline
import argparse
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default="/home/zliu/ACMMM2024/DiffusionMultiBaseline/pretrained_models/UNet_Simple/SD15/unet",
...
def Run_Inference_SD15_Unet(args):
    ...
    # read the pipelines.
    pipeline = SD15UNet_Simple_Finetune_Pipeline(unet=unet,vae=vae,
...
if __name__=="__main__":
    args = parse_args()
    Run_Inference_SD15_Unet(args=args)