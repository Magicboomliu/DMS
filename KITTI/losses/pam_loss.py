...
def loss_disp_unsupervised_multi(img_left, 
    ...
    mask_0 = torch.where(min_tensor_idx == 0, torch.tensor(True).to(img_left.device), torch.tensor(False).to(img_left.device))
    mask_1 = torch.where(min_tensor_idx == 1, torch.tensor(True).to(img_left.device), torch.tensor(False).to(img_left.device))
    mask_2 = torch.where(min_tensor_idx == 2, torch.tensor(True).to(img_left.device), torch.tensor(False).to(img_left.device))
...
def loss_disp_unsupervised_multi_plus_center(img_left, 
    ...
    mask_1 = torch.where(min_tensor_idx == 1, torch.tensor(True).to(img_left.device), torch.tensor(False).to(img_left.device))
    mask_2 = torch.where(min_tensor_idx == 2, torch.tensor(True).to(img_left.device), torch.tensor(False).to(img_left.device))
    mask_3 = torch.where(min_tensor_idx == 3, torch.tensor(True).to(img_left.device), torch.tensor(False).to(img_left.device))
