...
from models.CFNet.submodule import *
import math
...
class cfnet(nn.Module):
    ...
    def forward(self, left, right):
        ...
        if self.training:
            ...
            results_list =  [pred0_4, pred1_4, pred2_s4, pred0_s3, predmid_s3, pred1_s3_up, pred0_s2, predmid_s2, pred1_s2]
            
            results_list = [t.unsqueeze(1) for t in results_list]
...
if __name__=="__main__":
    ...
    from models.CFNet.loss import model_loss
    
    cfnet_model = CFNet(d=192).cuda()
    ...
    outputs = cfnet_model(left_input,right_input)
