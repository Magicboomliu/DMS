...
import argparse
import accelerate
from HuggingFace_Trainer.dataset_configuration import prepare_dataset,prepare_dataset_20152012
import math
...
def main():
    ...
    with accelerator.main_process_first():
        train_loader,test_loader,num_batches_per_epoch = prepare_dataset_20152012(datapath= args.datapath,
    ...
    if accelerator.is_main_process:
        ...
        # inference at here
        current_results = Inference_on_KITTI2015_Train(stereo_matching_network=stereo_matching_network,
